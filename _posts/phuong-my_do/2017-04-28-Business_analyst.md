...
* **Create documentation**: business processes and rules, data flow diagrams, mock-ups and wireframes, user stories, user acceptance criteria, functional and non-functional requirements, decision logs, scope and rationale of a project, user impact of any business and technical decisions. 50% of Brian’s job is to write documentation and the other 50% is to listen to and communicate with people to make sure the documentation is accurate and shared.
...
* For both activities described above, it is important to target the audience as Brian will not emphasize the same information. In one case, he wants to validate the rules that will impact the users, in the other he wants to break down these rules so the developers understand and can think of how this will impact the software.  

* **Analyse and track issues**: the issue has to describe a user behaviour but explore the technical aspects of it. A good understand of the BA of both functional and technical sides will help to better analyse issues.

* **UAT** (User Acceptance Testing):  the BA defines the user acceptance criteria of the software based on the requirements and business understanding and will perform quality assurance from a business perspective.
...
| Struggles | Unclear and changing requirements and functional specifications coming from the BAs |    Unclear and changing business requirements coming from the stakeholders |
| Must have skills | Analytical, technical, problem-solving, willingness to research, teamwork... |    Analytical, listening, communication, negotiation, documentation, teamwork... |

# Fun Facts
* Gender equality: The business analysis is the IT job where gender equality is best represented (most of the time it’s half-half but I have worked in a BA department with 8 female BA, 4 male BA and a female manager). Note that this fact is purely based on experience with no large-scale survey behind that. (...but I think it’s true...)
...
I think my job is awesome because it’s like having a tea-chat with everyone in a company to understand what they do. I’m not an expert in cancer genomics, I’m not an expert in software development but I do understand who to talk to and how topics relate to each other. 
