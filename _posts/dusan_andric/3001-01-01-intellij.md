...
Depending on the complexity of queries you indend to write, and the tools at hand, it can be cumbersome to write multi-select multi-join queries without having to test and retest different components in isolation of the main query.
